...
# Save VIX volatility data
vix_volatility_df.to_csv(os.path.join(result_folder, "vix_volatility.csv"), index=True)
...
# Save SPY calls data with implied volatility
calls.to_csv(os.path.join(result_folder, "calls_with_implied_volatility.csv"), index=False)
...
# Save the plot
plt.savefig(os.path.join(result_folder, "volatility_cone.png"))
plt.show()
